...
var install=function(hook,vm){
    ...
    var onScroll=function(e){
        ...
        hook.mounted(function(){var scrollBtn=document.createElement("span");
        ...
        scrollBtn.style.width="50px";scrollBtn.style.height="50px";
        ...
        scrollBtn.onclick=function(e){
            ...
            var scroll=function(){
                ...
                if(window.scrollY>0){setTimeout(scroll,15)}
            };
            scroll()
        }
    })
